...
//    public static final long AUTH_TOKEN_EXPIRATION_TIME = 60*1000; // 1 minute for test
    public static final long REFRESH_TOKEN_EXPIRATION_TIME = 60*1000*60*24*30L; // 1 month
//    public static final long REFRESH_TOKEN_EXPIRATION_TIME = 60*1000*5; // 5 minute for test
